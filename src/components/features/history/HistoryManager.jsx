...
import { EmptyState } from '@/components/ui/help-text';
import {
  getHistory,
  deleteHistoryItem,
  bulkDeleteHistory,
...
export function HistoryManager({ onSelectHistoryItem }) {
    ...
    return (
      <PageShell size="wide">
        <PageHeader
          ...
          description={t('tooltips.history')}
        />
        <EmptyState
          icon={History}
  ...
  return (
    <PageShell size="wide">
      ...
      <div className="flex items-center gap-2 rounded-xl border border-indigo-200/40 bg-indigo-50/30 p-3">
