/**
 * AI-powered content insights utilities (Backend)
 */

const { analyzeSentiment, detectLanguage } = require('../scrapers/extractors/analysisExtractors');
 ...
 */
function detectTopics(text, maxTopics = 5) {
  if (!text || text.length < 50) {
    return [];
  }
 ...
 */
function analyzeSentimentBySection(data) {
  const sections = {};
